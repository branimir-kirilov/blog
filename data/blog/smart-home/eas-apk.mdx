...
There are several ways that you can define a secret in EAS, I'll do this through the UI console. It's as simple as navigating to the ```Secrets``` tab, clicking on ```Create``` and then defining the name and the value of the secret:
 ...
 <p align="center" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
    <Image alt="eas-secrets-tab" src="/static/images/secrets.png" width={512} height={128} />
</p>
...
<p align="center" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
    <Image alt="eas-secrets-tab" src="/static/images/builds.png" width={512} height={128} />
</p>

<p align="center" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
    <Image alt="eas-install-tab" src="/static/images/install.png" width={512} height={128} />
</p>
...
<p align="center" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
    <Image alt="installed-app" src="/static/images/app-standalone.jpeg" width={512} height={128} />
</p>
